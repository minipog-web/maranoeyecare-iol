...
const lenses = [
  ...
  },
  {
    ...
    badge: 'Most Popular',
    twColor: 'text-[#c5a059]',
    twBadgeBg: 'bg-[#c5a05915]',
    twBadgeBorder: 'border-[#c5a05930]',
    twBadgeText: 'text-[#c5a059]',
    twCtaBorder: 'border-[#c5a05940]',
    twSpecBar: 'bg-[#c5a059]',
    images: {
      day: {
        distance: '/assets/images/day_driving_pro.jpg',
...
function blurClass(px: number): string {
  if (px <= 0) return 'scale-[1.05]';
  if (px <= 0.4) return 'blur-[0.4px] scale-[1.05]';
  if (px <= 0.8) return 'blur-[0.8px] scale-[1.05]';

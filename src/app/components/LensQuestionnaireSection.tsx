      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-8 sm:mb-10">
          ...
          <h2 className="font-display text-3xl sm:text-4xl font-bold text-foreground mb-3">
            Find Your{' '}
            <span className="text-gradient-primary">Perfect Lens</span>
          </h2>
          <p className="text-muted-foreground text-base max-w-xl mx-auto">
            Answer a few quick questions and we'll recommend the IOL best suited
            to your vision goals and lifestyle.
          </p>
        </div>
        ...
        <div
              ...
              <button
                ...
                'border-border bg-muted/40 hover:border-primary/50 hover:bg-primary/5 hover:scale-[1.01]'}`
                  ...
                  className={`shrink-0 mt-1 w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all duration-200
                        ${
                  selectedOption === idx ?
                  'border-primary bg-primary' : 'border-muted-foreground/40 group-hover:border-primary/60'}`
                  }>
          ...
          <div>
              ...
              <p className="mt-4 text-xs text-muted-foreground text-center">
                This recommendation is a starting point. Dr. Marano will review
                your full eye health history to confirm the best lens for you.
              </p>
            </div>)
          }
        </div>
        ...
        <p className="text-center text-xs text-muted-foreground mt-5 px-2">
            No personal information required · Takes about 60 seconds ·
            Results reviewed with Dr. Marano
          </p>
        }
      </div>
    </section>);

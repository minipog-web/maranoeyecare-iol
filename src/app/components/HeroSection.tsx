      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 w-full py-8 lg:py-24">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
          ...
          <div className="relative flex-1 w-full flex flex-col items-center">
            {/* Compare All 3 Lenses Badge — Positioned cleanly above cards to prevent image overlap */}
            <div className="mb-4 sm:mb-6 animate-fade-up delay-500 fill-both z-30">
              <a
                href="#lenses"
                onClick={() =>
                  trackEvent({
                ...
                className="inline-flex items-center gap-2.5 px-4 py-2 sm:px-5 sm:py-2.5 rounded-full border border-primary/35 bg-primary/10 hover:bg-primary/20 backdrop-blur-md text-primary text-xs sm:text-sm font-bold uppercase tracking-wider transition-all hover:scale-105 shadow-[0_0_24px_rgba(197,160,89,0.22)] group focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:outline-none"
              >
                <div className="w-6 h-6 rounded-full bg-primary/20 flex items-center justify-center shrink-0">
                  <Icon name="SparklesIcon" size={14} className="text-primary" />
                </div>
                <span>Compare All 3 Lenses</span>
                <Icon
                  name="ArrowRightIcon"
                  size={14}
            ...
            {/* Lens Cards Row */}
            <div className="w-full flex items-end justify-center gap-2 sm:gap-3 md:gap-4 py-2 overflow-x-auto sm:overflow-visible snap-x snap-mandatory sm:snap-none scroll-smooth -mx-4 px-4 sm:mx-0 sm:px-0">
              {lenses?.map((lens, i) => {
